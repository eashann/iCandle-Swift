...
class CollateralsVC: UIViewController {
    ...
    @IBOutlet weak var collateralsTableView: UITableView!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        collateralsTableView.delegate   = self
        collateralsTableView.dataSource = self
        getHolding()
    }
    ...
    func getHolding() {
        ...
        let request = NSMutableURLRequest(url: NSURL(string: "http://stock-eye.com/api/portfolio/collateral")! as URL,
                ...
                if let data = data {
                    do {
                        ...
                        DispatchQueue.main.async {
                            self.collateralsTableView.reloadData()
                        }
                    } catch {
                        DispatchQueue.main.async {
                            print("error:\(error)")
...
extension CollateralsVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = collateralsTableView.dequeueReusableCell(withIdentifier: "CollateralsCell") as! CollateralsCell
