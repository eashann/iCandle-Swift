...
class OpenPositionVC: UIViewController {
    ...
    @IBOutlet weak var openPositionTableView: UITableView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        openPositionTableView.delegate   = self
        openPositionTableView.dataSource = self
        getHolding()
    }
    ...
    func getHolding() {
        ...
        let request = NSMutableURLRequest(url: NSURL(string: "http://stock-eye.com/api/portfolio/openposition")! as URL,
...
extension OpenPositionVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = openPositionTableView.dequeueReusableCell(withIdentifier: "OpenPositionCell") as! OpenPositionCell
