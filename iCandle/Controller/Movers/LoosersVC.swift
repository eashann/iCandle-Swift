...
class LoosersVC: UIViewController {
    
    @IBOutlet weak var looserTableView: UITableView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        looserTableView.delegate   = self
        looserTableView.dataSource = self
        getLooser()
    }
    ...
    func getLooser() {
        ...
        let request = NSMutableURLRequest(url: NSURL(string: "http://stock-eye.com/api/TopMovers/percentdecrease")! as URL,
                ...
                if let data = data {
                    do {
                        ...
                        DispatchQueue.main.async {
                            self.looserTableView.reloadData()
                        }
                    } catch {
                        DispatchQueue.main.async {
                            print("error:\(error)")
...
extension LoosersVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = looserTableView.dequeueReusableCell(withIdentifier: "LooserCell") as! LooserCell
        ...
        cell.volumeCell.text    = String(volumeArr[indexPath.row])
