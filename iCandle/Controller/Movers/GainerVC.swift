...
class GainerVC: UIViewController {
    
    @IBOutlet weak var gainerTableView: UITableView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        gainerTableView.delegate   = self
        gainerTableView.dataSource = self
        getGainer()
    }
    ...
    func getGainer() {
        ...
        let request = NSMutableURLRequest(url: NSURL(string: "http://stock-eye.com/api/TopMovers/percentincrease")! as URL,
                ...
                if let data = data {
                    do {
                        ...
                        DispatchQueue.main.async {
                            self.gainerTableView.reloadData()
                        }
                    } catch {
                        DispatchQueue.main.async {
                            print("error:\(error)")
...
extension GainerVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = gainerTableView.dequeueReusableCell(withIdentifier: "GainerCell") as! GainerCell
